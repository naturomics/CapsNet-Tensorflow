...
flags.DEFINE_boolean('fixed_rough_range_bits', 6, 'Fixed-point bits for ranges for large distributions')
flags.DEFINE_boolean('fixed_rough_precision_bits', 6, 'Fixed-point bits for precisions for large distributions')
flags.DEFINE_boolean('fixed_fine_range_bits', 2, 'Fixed-point bits for ranges for small distributions')
flags.DEFINE_boolean('fixed_fine_precision_bits', 10, 'Fixed-point bits for precisions for small distributions')
