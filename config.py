...
flags.DEFINE_integer('fixed_fine_range_bits', 2, 'Fixed-point bits for ranges for small distributions')
flags.DEFINE_integer('fixed_fine_precision_bits', 10, 'Fixed-point bits for precisions for small distributions')
